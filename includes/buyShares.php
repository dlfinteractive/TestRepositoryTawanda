<?php
  ...
  session_start();
   ...
   include ('connections.php');
    ...
    $statement="MERGE INTO MAFMARKET_STUDENT_TO_COMPANY USING dual ON (STUDENT_ID='$student_id' AND COMPANY_ID='$company_id') WHEN MATCHED THEN UPDATE SET SHARE_TALLY=SHARE_TALLY+'$tally_total' WHEN NOT MATCHED THEN  INSERT (COMPANY_ID, SHARE_TALLY, STUDENT_ID, GAME_INST_ID) VALUES (:company_id,:tally_total,:student_id,:game_id)";
