...
function buyShares(){
  ...
  tally_total = document.getElementById("numBuy"+lastChar).value;
  ...
  thisCompany = window['company_name'+lastChar];
...
function sellShares(){
  ...
  tally_total = document.getElementById("numSell"+lastChar).value;
...
function checkTypeTotals(){
  ...
  // Buy empty val
  $('#buy1').submit(function(){
    thisId = $(this).attr('id'); 
    if (!$("#numBuy1").val()) {
      // textarea is empty
      alert("Please enter the number of Securities to buy.");
      //$("#numBuy1").effect( "bounce", { times:3 }, 500);
    }
  });
  $('#buy2').submit(function(){
    thisId = $(this).attr('id'); 
    if (!$("#numBuy2").val()) {
      // textarea is empty
      alert("Please enter the number of Securities to buy.");
